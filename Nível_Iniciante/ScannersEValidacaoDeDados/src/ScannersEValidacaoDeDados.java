...
public class ScannersEValidacaoDeDados {
    public static void main(String[] args) {
        /*
         * Scanner = É um jeito de trazer o usuário para dentro da aplicação; agora o usuário será capaz de colocar os dados e não ser algo arbitrário
